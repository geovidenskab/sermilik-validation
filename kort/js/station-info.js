...
const STATION_INFO = {
  MIT: {
    ...
    elevation: '515 m.o.h.',
    coords: '65.70638°N, 37.79915°W',
    sittedOn: 'Klippe ved Mittivakkat-gletsjerens ablations-zone',
    operator: 'Københavns Universitet + GEUS (PROMICE)',
    runningSince: '2009',
    photo: 'MIT.jpg',
    photoCaption: 'MIT-stationen på klippen ved Mittivakkat-gletsjeren, med gletsjersø og isrand i baggrunden. Foto fra feltbesøget august 2026, hvor stationen blev repareret.',

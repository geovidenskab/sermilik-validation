...
const stationLocations = {
  ...
  mit: {
    // Position rettet aug 2026: stationen står på klippen ved gletsjeren,
    // ikke på selve isen (GPS-position fra feltbesøget hvor den blev repareret).
    coords: [65.70638, -37.79915],
    title: 'PROMICE AWS — MIT (Mittivakkat)',
    html: `<h3>MIT — Mittivakkat-gletsjeren</h3>
      <p>Vejrstation på klippen ved Mittivakkat-gletsjerens ablations-zone.
         Et af verdens længst-løbende glaciale energi-budget-eksperimenter
         (siden 2009). Repareret ved feltbesøget i august 2026.</p>
      <p style="display:flex; gap:0.4rem; flex-wrap:wrap;">
...
// Det danske kort har bevidst ingen faste markører: eleverne måler måske et
// helt andet sted end i skolegården, og de sætter selv deres punkt. Lag-
// grupperne oprettes stadig (andre moduler importerer dem), de står bare tomme.
if (profil.visMarkoerer) {

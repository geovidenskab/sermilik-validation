...
const layerDefs = [
  ...
  // Satellit-baggrundskort (Sentinel-2 cloudless årsmosaikker + Esri Hybrid)
  { group: 'basemaps-satellit', type: 'radio', radioGroup: 'basemap', id: 's2_2024',
    name: 'Sentinel-2 cloudless 2024',
    desc: 'Skyfri årsmosaik, 10 m. Sammenlign med tidligere år for is-/sneændringer.',
    layer: basemaps.s2_2024, on: true },
  { group: 'basemaps-satellit', type: 'radio', radioGroup: 'basemap', id: 's2_2023',
    name: 'Sentinel-2 cloudless 2023',
    desc: 'Mellemvalg til serieanalyse.',
    layer: basemaps.s2_2023 },
  { group: 'basemaps-satellit', type: 'radio', radioGroup: 'basemap', id: 's2_2022',
    name: 'Sentinel-2 cloudless 2022',
    desc: 'Toggle 2022 ↔ 2024 for at se ændringer over 2 år.',
    layer: basemaps.s2_2022 },
  { group: 'basemaps-satellit', type: 'radio', radioGroup: 'basemap', id: 's2_2020',
  ...
  { group: 'basemaps-satellit', type: 'radio', radioGroup: 'basemap', id: 'esri_hybrid',
    ...
    desc: 'Esri/Maxar satellit + stednavne — variabel opløsning over Grønland (~1 m omkring bygder, 250 m længere væk).',
    layer: basemaps.esri_hybrid },

  // ─── DANSKE BAGGRUNDSKORT ───────────────────────────────────────────────────
  // Vises kun på det danske kort: sektionen findes ikke i Sermilik-siden, og
  // defs uden vært springes over. Gratis Dataforsyningen-data — de koster
  // ingenting af Sentinel Hub-kvoten.
  { group: 'basemaps-dk', type: 'radio', radioGroup: 'basemap', id: 'ortofoto',
    name: 'Ortofoto — luftfoto (12,5 cm)',
    desc: 'Forårsflyvning fra Dataforsyningen. Så skarpt at én Sentinel-2 pixel på 10 m dækker 80×80 af disse — det er her, den blandede pixel bliver synlig.',
    layer: basemaps.ortofoto, on: true },
  { group: 'basemaps-dk', type: 'radio', radioGroup: 'basemap', id: 'skaermkort',
    name: 'Skærmkort (Dataforsyningen)',
    desc: 'Almindeligt dansk kort med veje, bygninger og stednavne. Godt til at finde adressen, før du skifter til luftfoto.',
    layer: basemaps.skaermkort },
  ...
  { group: 'gibs-layers', id: 'gibs_truecolor',
    ...
    layer: basemaps.modis_truecolor, defaultOpacity: 0.9 },
...
function buildLayerControl(def, onBasemapChange) {
  ...
  // Sektionen kan være fjernet fra panelet (fx GIBS) — så springes laget over.
  const host = document.getElementById(def.group);

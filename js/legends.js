...
export const LEGENDS = {
  ...
  VEGETATION_INDEX: {
    ...
    type: 'gradient',
    unit: '−1 til +1',
    description: '(B8−B4)/(B8+B4). Sentinel Hub default-skala: rød = ingen vegetation, grøn = tæt vegetation.',
    stops: [
      { value: '+0.8', label: 'tæt vegetation', color: '#0f6020' },
      { value: '+0.6', label: '', color: '#33a047' },
      { value: '+0.4', label: 'spredt vegetation', color: '#9ec92e' },
      { value: '+0.2', label: 'sparsomt', color: '#f0e22a' },
      { value: '0.0', label: 'bart / sne / vand', color: '#e69e18' },
      { value: '< 0', label: 'vand / sky', color: '#a82a18' },
    ],
  },
  ...
  MOISTURE_INDEX: {
    ...
    type: 'gradient',
    unit: '−1 til +1',
    description: '(B8A−B11)/(B8A+B11). Sentinel Hub default-skala: brun tør → blå våd.',
    stops: [
      { value: '+0.5', label: 'meget våd', color: '#0a3d75' },
      { value: '+0.2', label: 'fugtig', color: '#3a8cc9' },
      { value: '0.0', label: '', color: '#a3d4f5' },
      { value: '−0.2', label: 'tør', color: '#d9b04a' },
      { value: '< −0.4', label: 'meget tør', color: '#7a4a1c' },
    ],
  },
